...
const MovieTitleLengthTooShortException = new BadRequestException(
  '영화 제목은 3글자 이상이어야 합니다.',
);
const MovieTitleRequiredException = new BadRequestException(
  '영화 제목은 필수 입력 항목입니다.',
);

const MovieTitleArrayNotAllowedException = new BadRequestException(
  '배열은 허용되지 않습니다.',
);
...
{
  constructor(private readonly options?: MovieTitleValidationPipeOptions) {}
